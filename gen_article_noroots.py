...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Как восстановить утраченные актовые записи и получить легальное право на гражданство Румынии или Болгарии, если вы ничего не знаете о своих предках."
    }
    </script>
</head>
<body>
        ...
        <div class="container" style="max-width: 900px; margin: 0 auto; padding-top: 40px;">
            ...
            <article style="background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(11,32,70,0.05);">
                ...
                <div class="article-content" style="padding: 50px; font-size: 1.15rem; line-height: 1.8; color: #334155;">
                    ...
                    <p>
                        Чтобы понять, почему отсутствие семейных преданий о румынских или болгарских предках не является приговором, нужно посмотреть на историю ХХ века. Границы государств Восточной Европы и СССР, в частности Бессарабии, Северной Буковины и Одесской области, перекраивались несколько раз.
                    </p>
                    <p>
                    ...
                    <p>
                        Именно поэтому тот факт, что ваша семья последние 50 лет живет в России или Казахстане, <strong>никак не исключает</strong> того, что ваши прадеды могли быть рождены на территориях, попадающих под законы о репатриации Румынии или Болгарии. Просто об этом не принято было говорить в советское время.
                    </p>
                    ...
                    <p>
                        Главный страх клиента — получить фальшивый документ. Министерство Юстиции и Агентство по делам гражданства (ANC в Румынии) обладают прямыми протоколами для верификации любых иностранных выписок.
                    </p>
                    <p>
